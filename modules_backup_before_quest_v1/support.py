...
class Support(Module):
    ...
    def get_social_channels(self, msg, client):
        channels = []
        channels.append({"act": True, "prt": 1, "id": 1, "stid": "AVATARLIFE",
                         "dsctn": "Avatar Life #2017",
                         
                         "ttl": "Avatar Life #2017 Resmi Discord Sunucusu", "icnurl": icon,
                         "lnk": "https://discord.gg/bTNstU2FQj"})
